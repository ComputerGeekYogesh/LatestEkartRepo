...
<body>
    ...
    <div class="container">
        ...
        <div class="body-section">
            <div class="">
                ...
                <div class="">
                    ...
                    <p class="sub-heading">Address:{{ $orders->users->address1 . ','.$orders->users->address2}}  </p>
                    <p class="sub-heading">Phone Number: {{ $orders->users->phone}} </p>
                    <p class="sub-heading">City,State,Pincode:
                         {{ $orders->users->city}}, {{ $orders->users->state}}, {{ $orders->users->pincode}} </p>
                </div>
            </div>
        </div>
        ...
        <div class="body-section">
            <p>&copy; Copyright 2021 - Ekart. All rights reserved.
                <a href="https://www.ekart.com/" class="float-right">www.ekart.com</a>
            </p>
        </div>
    </div>
